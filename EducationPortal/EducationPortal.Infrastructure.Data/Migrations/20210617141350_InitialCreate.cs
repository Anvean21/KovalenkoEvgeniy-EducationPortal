        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Resource = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "PublishDate", "Resource" },
                values: new object[] { 1, new DateTime(2021, 6, 17, 17, 13, 49, 895, DateTimeKind.Local).AddTicks(7328), "Metanit.com" });

            migrationBuilder.InsertData(
                table: "BookMaterial",
                columns: new[] { "Id", "Author", "Format", "Pages", "YearOfPublish" },
                values: new object[] { 3, "Richetr", 2, 236, 2006 });

            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "Id", "Description", "Name", "TestId", "UserId", "UserId1" },
                values: new object[] { 1, "Description", "Course", 1, null, null });

            migrationBuilder.InsertData(
                table: "VideoMaterial",
                columns: new[] { "Id", "Duration", "Quality" },
                values: new object[] { 2, "19,27", 2 });
